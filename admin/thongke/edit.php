...
<div class="p-3 py-5 bg-white shadow rounded mt-5 ms-2 " style="width: 855px">
    ...
    <form action="index.php?url=update_rooms" method="POST">
        <div class="row mt-2">
            ...
            <div class="col-md-6"><input type="text" name="name_room" class="form-control" placeholder="name service" value="<?=$ma_rooms?>"></div>
        </div>
        <div class="row mt-3">
            <div class="col-md-6"><input type="text" name="name" class="form-control" placeholder="tên khách hàng" value="<?=$don_gia?>"></div>
            <div class="col-md-6"><input type="text" name="email" class="form-control" placeholder="email" value="<?=$service_id?>"></div>
        </div>
        <div class="row mt-3">
            <div class="col-md-6"><input type="text" name="sdt" class="form-control" placeholder="số điện thoại" value="<?=$id_type_rooms?>"></div>
        </div>
